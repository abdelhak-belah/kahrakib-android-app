...
public class CassierRespoRequestModel {
    ...
    public CassierRespoRequestModel() {
    }

    public CassierRespoRequestModel(String email, String motDePasse, String nom, String prenom, String dateNaissance, String chantierImputation) {
        this.email = email;
